export const API_ENDPOINTS = {
  ...
  // Performance
  MANAGER_ANALYTICS_PERFORMANCE: '/telecaller/manager/analytics/performance',
  MANAGER_ANALYTICS_CONVERSION_FUNNEL: '/telecaller/manager/analytics/conversion-funnel',
  MANAGER_ANALYTICS_TELECALLER_PERFORMANCE: '/telecaller/manager/analytics/telecaller/:id/performance',
